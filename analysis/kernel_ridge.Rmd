...
as_tibble(cv_results_best)
```
The model explained `r round(mean(cv_results_best$r2), 4)*100`% of the variance on average. The lower $R^2$ value is unsurprising for this model, as in contrast to the first model, observations were not averaged over the whole of Chicago.
